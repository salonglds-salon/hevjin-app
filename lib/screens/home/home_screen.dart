  ...
  Widget _leftColumn(UserProfile profile) {
    return Column(
      children: [
        ...
        _InlineChips(title: 'SPORT', field: 'sports', selected: const [], options: const ['Fitness', 'Fussball', 'Schwimmen', 'Joggen', 'Yoga', 'Boxen', 'Basketball', 'Tennis', 'Kampfsport', 'Tanzen', 'Radfahren', 'Wandern']),
        const SizedBox(height: 12),

        // REISEN - Inline klickbar
        _InlineChips(title: 'REISEN', field: 'travel', selected: const [], options: const ['Strandurlaub', 'Staedtereisen', 'Aktivurlaub', 'Camping & Natur', 'Wellness', 'Backpacking', 'Familienurlaub', 'Kreuzfahrt']),
        const SizedBox(height: 12),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 14),
              _steckbriefRow(Icons.location_on_outlined, AppLocalizations.of(context)?.city ?? 'WOHNORT', profile.city ?? '-',
              ...
              _steckbriefRow(Icons.groups_outlined, AppLocalizations.of(context)?.tribe ?? 'STAMM', profile.tribe ?? '-',
              ...
              _steckbriefRow(Icons.work_outline, AppLocalizations.of(context)?.job ?? 'BERUF', profile.job ?? '-',
              ...
              _steckbriefRow(Icons.straighten, 'GR\u00d6SSE', profile.height != null ? '${profile.height} cm' : '-',
                onTap: () => showSliderEditSheet(context, title: 'Gr\u00f6\u00dfe', field: 'height', currentValue: profile.height ?? 175)),
              _steckbriefRow(Icons.school_outlined, AppLocalizations.of(context)?.education ?? 'BILDUNG', profile.education != null ? profile.educationDisplay : '-',
              ...
              _steckbriefRow(Icons.interests, 'INTERESSEN', profile.interests.isNotEmpty ? profile.interests.take(3).join(', ') : '-'),
              _steckbriefRow(Icons.smoke_free, 'RAUCHEN', profile.smoking ?? '-',
              ...
              _steckbriefRow(Icons.fitness_center, 'SPORT', profile.sports.isNotEmpty ? profile.sports.take(3).join(', ') : '-'),
              ...
              _steckbriefRow(Icons.favorite_outline, 'FAMILIENSTAND', profile.familyStatus != null ? profile.familyStatusDisplay : 'ledig',
              ...
              _steckbriefRow(Icons.child_friendly, 'KINDERWUNSCH', profile.childWish ?? 'Keine Angabe',
